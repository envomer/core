							...
							<tr>
								<td style="padding: 10px 10px;">
									<table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="font-size: 14px;text-align: left;">
										<tr>
											<td>
                                                <img src="<?php echo isset($section->images[0]) ? $section->images[0] : 'http://placehold.it/310/222' ?>" width="310" height="" border="0" alt="alt_text" class="center-on-narrow" style="width: 100%; max-width: 310px; height: auto; background: #dddddd; font-family: sans-serif; font-size: 15px; line-height: 140%; color: <?php $this->getStyle('color', '#222222') ?>;">
											</td>
										</tr>
										<tr>
							...
							<tr>
								<td style="padding: 10px 10px;">
									<table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="font-size: 14px;text-align: left;">
										<tr>
											<td>
                                                <img src="<?php echo isset($section->images[1]) ? $section->images[1] : 'http://placehold.it/310/222' ?>" width="310" height="" border="0" alt="alt_text" class="center-on-narrow" style="width: 100%; max-width: 310px; height: auto; background: #dddddd; font-family: sans-serif; font-size: 15px; line-height: 140%; color: <?php $this->getStyle('color', '#222222') ?>;">
											</td>
										</tr>
										<tr>
											<td style="font-family: sans-serif; font-size: 15px; line-height: 140%; color: <?php $this->getStyle('color', '#222222') ?>; padding-top: 10px;" class="stack-column-center">
